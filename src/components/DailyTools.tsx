...
import { Utensils, FileBox, CalendarDays, Mail, HardDrive, MessageSquare, Calendar, StickyNote, BookOpen, Bot } from 'lucide-react';
...
const getIcon = (type: string) => {
  switch (type) {
    ...
    case 'ai':
      return <Bot className="h-4 w-4 mr-2 text-pink-500" />;
    default:
